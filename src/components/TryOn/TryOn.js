    ...
    <div className="container">
      ...
      <div className="process-box">
        ...
        <div className="process-buttons">
          <button onClick={runMainScript} disabled={loading}>Run Main Script</button> {/* Disable button based on loading state */}
          <button onClick={displayFinalImage} disabled={loading}>Display Final Image</button> {/* Disable button based on loading state */}
        </div>
        {uploadStatus.mainScript && (
          <NotificationMessage
            status={uploadStatus.mainScript}
            message={uploadStatus.mainScript === 'success' ? 'Main Script Executed Successfully' : 'Failed to Execute Main Script. Please try again'}
          />
        )}
